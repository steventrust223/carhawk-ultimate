...
// NOTE: UI Dialog Functions (showDealGallery, showQuickActions, etc.) are defined in quantum_ui.gs
...
// NOTE: Menu handler functions (openSpeedToLead, openPipelineView, etc.) are defined in quantum_menu_handlers.gs
