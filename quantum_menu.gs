...
function createQuantumMenu() {
  ...
  ui.createMenu('⚙️ CarHawk Ultimate')
    ...
    .addSubMenu(ui.createMenu('🤖 Browse.ai Robots')
      ...
      .addSeparator()
      .addItem('⛓️ Link Robot Chain (List + Detail)', 'linkBrowseAIChainUI')
      .addItem('🪝 Register Chain Webhooks', 'registerChainWebhooksUI')
      .addItem('⛓️ Deploy Robot Chain', 'deployChainUI')
      .addItem('🔄 Process Chains (no webhook)', 'processChainsPollUI')
      .addSeparator()
